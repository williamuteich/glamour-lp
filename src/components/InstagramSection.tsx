...
const InstagramSection = () => {
    useEffect(() => {
        // Carrega o script do Instagram se ainda não estiver na página
        if (!document.getElementById("instagram-embed-script")) {
            ...
            // Se já existir, processa os novos embeds
    ...
    const posts = [
        "https://www.instagram.com/p/DWJkC1uEZ5p/",
        "https://www.instagram.com/p/DWEsvX7keGy/",
        "https://www.instagram.com/reel/DKw9e7oRbwj/",
        "https://www.instagram.com/reel/Cz9O7lOLqlk/",
        "https://www.instagram.com/p/DWtoXK9kYkn/",
        "https://www.instagram.com/p/DWmBEWxERz9/"
    ];
            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16 space-y-4">
                    <div className="flex items-center justify-center gap-3">
                        ...
                        <p className="text-primary font-body text-xs tracking-[0.35em] uppercase font-light">Instagram</p>
                        <div className="h-px w-10 bg-primary" />
                    </div>
                    <h2 className="font-display text-4xl sm:text-5xl font-light text-foreground">
                        Acompanhe nosso <span className="text-gradient-gold italic">trabalho</span>
                    </h2>
                    <p className="text-muted-foreground font-light max-w-md mx-auto pt-2">
                        Confira as últimas novidades e perfurações realizadas em nosso estúdio.
                    </p>
                </div>
                                        ...
                                        >
                                            <div style={{ padding: "16px" }}>
                                                ...
                                                <p style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: "14px", lineHeight: "17px", marginBottom: 0, marginTop: "8px", overflow: "hidden", padding: "8px 0 7px", textAlign: "center", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                                                    <a href={url} style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: "14px", fontStyle: "normal", fontWeight: "normal", lineHeight: "17px", textDecoration: "none" }} target="_blank" rel="noopener noreferrer">A post shared by Glamour Acessórios (@glamour_lindoia)</a>
                                                </p>
                                            </div>
                                        </blockquote>
                                    </div>
